...
const App: React.FC = () => {
    ...
    return (
        <div className="flex h-screen w-full transition-colors duration-500 bg-transparent text-slate-900 dark:text-white overflow-hidden">
            ...
            <motion.aside 
                layout
                className={`fixed sm:relative z-50 h-full flex flex-col glassmorphic-sidebar group/sidebar ${isSidebarOpen ? 'translate-x-0 p-4' : '-translate-x-full sm:translate-x-0 p-4'}`}
                initial={false}
                animate={{ 
